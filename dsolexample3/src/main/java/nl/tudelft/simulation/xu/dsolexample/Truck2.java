...
public class Truck2 extends AtomicModel
{
	...
	//private String filename1 = "C:/Users/ASUS/Desktop/data/initial/loadDist-increase-30/waiting_at_warehouseB.txt";
	//private String filename2 = "C:/Users/ASUS/Desktop/data/initial/loadDist-increase-30/waiting_at_dockB.txt";
	...
	public Truck2(String modelName, CoupledModel parentModel)
	{
	...
	protected void deltaExternal(double e, Object value)
	{
		if (this.activePort.equals(load_finish) && ((String) value).equals(getModelName()))
		{
			...
			{
				setPhase(TRAVEL_TO_WAREHOUSE, timeTravelWhenFull);
				printDebugMessage("function: deltaExternal(" + e + "," + value + ")[unload finish]; reaction: " + WAITING
		...
		if (this.activePort.equals(unload_finish) && ((String) value).equals(getModelName()))
		{
			...
			{
				setPhase(TRAVEL_TO_DOCK, timeTravelWhenEmpty);
				printDebugMessage("function: deltaExternal(" + e + "," + value + ")[load finish]; reaction: "
	...
	protected void lambda()
	{
		if (this.current_status.equals(TRANSIENT_PHASE) || this.current_status.equals(TRAVEL_TO_DOCK))
		{
			...
			this.out.send("Truck_Arrived_DockB");
			printDebugMessage("function: lambda(); phase: " + this.current_status + "; message: arrive at dockB.");
		}
		if (this.current_status.equals(TRAVEL_TO_WAREHOUSE))
		{
